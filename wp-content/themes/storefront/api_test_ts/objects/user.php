...
class User{ 
    ...
    function forgetpass(){	
        ...
        define( 'API_ACCESS_KEY', 'AIzaSyAfgwiZo9jpMBEt-OrSmSYlT-CvwqB9-Eo' ); // AIzaSyDtY_FUGSOSWD_vkmcmhmyVh8kmt31pA5s
  ...
  function home(){    
    ...
    function vendor_counts($post_processing_id,$vendor_object_id,$vendor_account){   //print_r($post_processing_id);
            $v=0;
             //print_r($value[ID]);
    ...
    public function update_prod() {  
        ...
        if($stmt->rowCount() > 0){
            ...
            if($this->sale_price){
				...
				update_post_meta($this->p_id, '_sale_price', $this->regular_price);
			}
            if($this->sku){
